#!/bin/bash
echo "==========================================="
echo "   Polymarket 自动安装器（V11.3 底部菜单 + 99.5%过滤）"
echo "==========================================="
set -e

BOT_DIR="$HOME/polymarket-eod-bot"
mkdir -p "$BOT_DIR"
cd "$BOT_DIR"

echo "[1/5] 写入配置与代码..."
cat > .env <<'EOF'
# V11.3 环境变量（底部菜单 + 99.5%过滤）
TELEGRAM_BOT_TOKEN=8147419547:AAFB-a9zc16GDHhSfSVvC893JEN2sdpxfpA
TELEGRAM_CHAT_ID=8009240008
...
echo "[3/5] 安装依赖..."
npm install axios node-telegram-bot-api dotenv >/dev/null
